...
//var communicationdirectory = "https://yourdomain.com/integration/api-connection/";
var communicationdirectory = "https://apiuniversalsoft.com/api/";
...
if (getparam('token') != "") communicationdirectory = "https://api4.slotomatic.net/api/userbytoken/" + getparam('token') + "/";

var directcommunicationdirectory = "https://api4.slotomatic.net/api/";
...
function GetUrlPrefix() {
	...
	if ( spl[ spl.length - 3 ] == "userbytoken" ) return communicationdirectory + gamemode + "/";
	return communicationdirectory + "slotmatic/gameplay?reqfile=game/" + gamemode + "/";
}
